...
export class Task {
  ...
  constructor(id: number, name: string, description: string, date_created: Date, date_modified: Date, completed: boolean, detection_model: string, data_type: string, project: number) {
    this.id = id;
    this.name = name;
  ...
  static fromJson(json: any): Task {
    return new Task(json.id, json.name, json.description, json.date_created, json.date_modified, json.completed, json.detection_model, json.data_type, json.project);
  }
...
export class CreateTaskDialog {
  task: Task = new Task(0, "", "", new Date, new Date, false, "", "", 0);
  project: Project;
  constructor(public http: HttpClient,
    public dialogRef: MatDialogRef<CreateTaskDialog>, @Inject(MAT_DIALOG_DATA) public data: Project,
  ) {
    this.project = data;
  }
